...
const Header = () => {
  ...
  return (
    <>
      ...
      {!big && (
        <div className="border-b border-[#D6A6A6]">
          <div className="w-full h-[1px] bg-[#D6A6A6] flex justify-center items-center"></div>
          <div className=" px-10 pb-2 pt-4 grid grid-cols-3 items-center">
            ...
            <div className="">
              <Link
                to="/"
                className="flex flex-col items-center border-b border-[#D6A6A6] pb-2"
              >
                <h1 className="font-black text-[#D6A6A6] text-4xl">ADC</h1>
              </Link>
            </div>
